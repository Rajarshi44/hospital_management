...
import { UserCheck, Activity, FileText, Users, Clock, AlertTriangle, TrendingUp, Bed, Building2 } from "lucide-react"
import Link from "next/link"
import { mockAdmissions, mockWards, getDaysAdmitted } from "@/lib/ipd-mock-data"
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Comprehensive inpatient department management and monitoring
          </p>
        </div>
            ...
            {wardStats.map((ward) => (
              <div key={ward.id} className="border rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge variant={ward.occupancyRate > 90 ? "destructive" : 
                                ward.occupancyRate > 70 ? "default" : "secondary"}>
                    {ward.occupancyRate}%
                  </Badge>
                </div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div className="flex-1 bg-gray-200 rounded-full h-2">
                    <div className={`h-2 rounded-full transition-all duration-300 ${
                      ward.occupancyRate > 90 ? 'bg-red-500 w-full' :
                      ward.occupancyRate > 70 ? 'bg-yellow-500 w-4/5' : 'bg-green-500 w-3/5'
                    }`} />
                  </div>
