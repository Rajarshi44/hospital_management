...
export default function DischargePage() {
  ...
  const dischargeableAdmissions = mockAdmissions.filter(admission => 
  ...
  const filteredAdmissions = dischargeableAdmissions.filter(admission => {
    ...
    return admission.patientName.toLowerCase().includes(query) ||
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'stable': return <UserCheck className="h-3 w-3" />
      case 'observation': return <Clock className="h-3 w-3" />
      default: return null
    }
  }
  ...
  const calculateEstimatedCharges = (admission: any) => {
    ...
    const bedCharges = days * (admission.bedId === '21' || admission.bedId === '22' || admission.bedId === '23' ? 1200 : 
                              admission.bedId === '11' || admission.bedId === '12' || admission.bedId === '13' ? 500 : 150)
    ...
    <AuthProvider>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Process patient discharges and generate discharge summaries
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Find patients ready for discharge by name, admission ID, or UHID
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a patient to initiate discharge process
          </CardDescription>
        </CardHeader>
        <CardContent>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          <div className="text-xs text-muted-foreground">
                            Dr. {admission.consultingDoctorName}
                          </div>
                        </div>
                      </TableCell>
                      <TableCell>
                        ...
                        <div className="space-y-1">
                          ...
                          {admission.initialDeposit && (
                            <div className="text-xs text-green-600">
                              Deposit: ${admission.initialDeposit}
                            </div>
                          )}
                        </div>
                      </TableCell>
