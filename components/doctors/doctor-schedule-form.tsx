...
export function DoctorScheduleForm({ 
  ...
  const checkOverlaps = (formData: ScheduleFormData) => {
    ...
    const overlaps = existingSchedules.filter(existing => {
      ...
      const hasCommonDay = existing.workingDays.some(day => 
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          type="date" 
                          {...field} 
                          placeholder="Leave empty for always"
                        />
                      </FormControl>
                      <div className="text-xs text-muted-foreground">
                        Leave empty for permanent schedule
                      </div>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            render={({ field }) => (
              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <div className="text-sm text-muted-foreground">
                    Enable this schedule for appointments
                  </div>
                </div>
                <FormControl>
                  <Switch
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <Button 
              type="submit" 
              disabled={overlappingSchedules.length > 0}
            >
